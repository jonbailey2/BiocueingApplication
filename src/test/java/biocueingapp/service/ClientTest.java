...
public class ClientTest {
    ...
    Client expectedClient = new Client(UUID.randomUUID(), new ClientInfo(), new DevelopmentalInfo(),
    ...
    @Test
    void createClient() {
        Client actualClient = clientService.addClient(expectedClient.getId(), new ClientInfo(),
                    new DevelopmentalInfo(), new MedicalInfo(), new EmergencyInfo(), new Biofeedback());
